...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void saveChanges_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                // If the user has changed the same students earlier, 
                // then overwrite their changes with the new data
            ...
            {
                // If some sort of database exception has occurred, then display the reason 
                // for the exception and rollback
