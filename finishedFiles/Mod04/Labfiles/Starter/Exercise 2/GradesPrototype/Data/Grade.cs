            ...
            set
            {
                ...
                if (DateTime.TryParse(value, out assessmentDate))
                {
                    ...
                    if (assessmentDate > DateTime.Now)
                    {
                        ...
                        throw new ArgumentOutOfRangeException("AssessmentDate",
                                                "Assessment date must be on or before the current date");
                    }
                ...
                else
                {
                    ...
                    throw new ArgumentException("AssessmentDate",
                                         "Assessment date is not recognized");
                }
            }
        }
        ...
        private string _assessment;
         public string Assessment
         {
            ...
            set
            {
                ...
                // Use a regular expression: a single character in the range A-E at 
                // the start of the string followed by an optional + or – at the end 
                //of the string
                ...
                else
                {
                    ...
                    throw new ArgumentOutOfRangeException("Assessment",
                                   "Assessment grade must be in the range of A+ to E-");
                }
            }
        }
