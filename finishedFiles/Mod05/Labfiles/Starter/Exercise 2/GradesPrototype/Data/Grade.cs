...
namespace GradesPrototype.Data
{
    ...
    public class Student: User, IComparable<Student>
    {
        ...
        public override bool SetPassword(string pwd)
        {
            ...
            // If the password provided as the parameter is at least 6 characters
            // long then save it and return true
            ...
            // If the password is not long enough, then do not save it and 
            // return false
            return false;
    ...
    public class Teacher : User
    {
        ...
        public override bool SetPassword(string pwd)
        {
            ...
            // Use a regular expression to check that the password contains at 
            // least two numeric characters 
            ...
            // If the password is not complex enough, then do not save it and 
            //return false
            return false;
